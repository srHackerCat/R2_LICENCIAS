...
namespace MyCompany.Web
{
    ...
    public class AquariumExtenderBase : ExtenderControl
    {
        ...
        protected override System.Collections.Generic.IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            if (uiFramework && ((!EnableCombinedScript || (HttpContext.Current.Request.Params["_cf"] == "bootstrap")) && Convert.ToBoolean(ApplicationServicesBase.Settings("server.bootstrap.js"))))
        ...
        public static void RegisterFrameworkSettings(Page p)
        {
            if (!p.ClientScript.IsStartupScriptRegistered(typeof(AquariumExtenderBase), "TargetFramework"))
            {
                ...
                p.ClientScript.RegisterStartupScript(typeof(AquariumExtenderBase), "TouchUI", (("var __settings=" + ApplicationServices.Create().UserSettings(p).ToString(Newtonsoft.Json.Formatting.None)) + ";"), true);
            }
        }
