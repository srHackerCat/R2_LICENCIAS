...
namespace MyCompany.Handlers
{
    ...
    public class SiteBase : MyCompany.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2022 MyCompany. ^Copyright^All rights reserved.^Copyright^";
            }
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!isRESTfulRequest && (User.Identity.IsAuthenticated && !ApplicationServices.AllowUI(User.Identity.Name)))
            {
                ...
                ApplicationServicesBase.Create().RedirectToLoginPage();
                Response.End();
            }
            ...
            else
            {
                if (_isTouchUI)
                {
                    _pageContent.Text = "<div id=\"PageContent\" style=\"display:none\"><div data-app-role=\"page\">404 Not Found</div></div>";
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (Context.Items["AppState"] == null)
            {
