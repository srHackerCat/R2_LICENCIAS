...
namespace MyCompany.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedByUserNameRegex = new Regex("USUARIO_ACTUALIZA|UsuarioActualiza", RegexOptions.IgnoreCase);

        private static Regex _modifiedByUserIdRegex = null;

        private static Regex _modifiedOnRegex = new Regex("FECHA_ACTUALIZA|FechaActualiza", RegexOptions.IgnoreCase);

        private static Regex _createdByUserNameRegex = new Regex("USUARIO_CREA|UsuarioCrea", RegexOptions.IgnoreCase);

        private static Regex _createdByUserIdRegex = null;

        private static Regex _createdOnRegex = new Regex("FECHA_CREA|FechaCrea", RegexOptions.IgnoreCase);
